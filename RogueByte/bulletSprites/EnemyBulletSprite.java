...
public class EnemyBulletSprite implements DisplayableSprite, MovableSprite {
    ...
    public EnemyBulletSprite(double startX, double startY, double angleInDegrees,
                             int speed, String imageURL, int tiltangle, int lifetime, int dmg) {
        this.dmg = dmg;
        this.centerX = startX;
        this.centerY = startY;
        this.deltaX = Math.cos(Math.toRadians(angleInDegrees)) * speed;
